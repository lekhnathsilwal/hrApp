            ...
            <div class="col-md-12">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="{{route('store.forget.password',['id'=>$id])}}" method="post" id="loginForm">
                            @csrf
                            <div class="form-group">
{{--                                <label class="control-label" for="email">Email</label>--}}
{{--                                <input type="email" placeholder="hello@example.com" title="Email" required="" name="email" id="email" class="form-control">--}}
{{--                                <span class="help-block small">Your email</span>--}}
                                <label class="control-label" for="password">Password</label>
                                <input type="password" placeholder="********" title="Password" required="" name="password" id="password" class="form-control">
